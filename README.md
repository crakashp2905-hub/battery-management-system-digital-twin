...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-0.40.0-blue">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-404%20passing-brightgreen">
...
> **Status.** ✅ 404/404 unit tests pass • 47 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 404 unit tests; pip-installable
...
├── tests/test_bms.py          # 404 unit tests
