...
> **Status.** ✅ 271/271 unit tests pass • 27 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 271 unit tests; pip-installable
...
├── tests/test_bms.py          # 271 unit tests
