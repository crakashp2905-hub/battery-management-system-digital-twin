...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-0.46.0-blue">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-445%20passing-brightgreen">
...
> **Status.** ✅ 445/445 unit tests pass • 53 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 445 unit tests; pip-installable
...
├── tests/test_bms.py          # 445 unit tests
