...
> **Status.** ✅ 379/379 unit tests pass • 41 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 379 unit tests; pip-installable
...
├── tests/test_bms.py          # 379 unit tests
