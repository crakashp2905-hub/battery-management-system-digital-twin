...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-0.44.0-blue">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-432%20passing-brightgreen">
...
> **Status.** ✅ 432/432 unit tests pass • 51 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 432 unit tests; pip-installable
...
├── tests/test_bms.py          # 432 unit tests
