...
> **Status.** ✅ 315/315 unit tests pass • 33 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 315 unit tests; pip-installable
...
├── tests/test_bms.py          # 315 unit tests
