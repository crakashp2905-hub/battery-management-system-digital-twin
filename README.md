...
> **Status.** ✅ 276/276 unit tests pass • 27 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 276 unit tests; pip-installable
...
├── tests/test_bms.py          # 276 unit tests
