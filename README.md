...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-0.35.0-blue">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-385%20passing-brightgreen">
...
> **Status.** ✅ 385/385 unit tests pass • 42 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 385 unit tests; pip-installable
...
├── tests/test_bms.py          # 385 unit tests
