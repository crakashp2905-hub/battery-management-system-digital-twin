...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-0.41.0-blue">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-409%20passing-brightgreen">
...
> **Status.** ✅ 409/409 unit tests pass • 47 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 409 unit tests; pip-installable
...
├── tests/test_bms.py          # 409 unit tests
