...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-0.42.0-blue">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-416%20passing-brightgreen">
...
> **Status.** ✅ 416/416 unit tests pass • 48 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 416 unit tests; pip-installable
...
├── tests/test_bms.py          # 416 unit tests
