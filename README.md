...
<p>
  <img alt="version" src="https://img.shields.io/badge/version-0.49.0-blue">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-469%20passing-brightgreen">
...
> **Status.** ✅ 469/469 unit tests pass • 57 library modules • 7 chemistries • ruff-clean •
...
- **Reproducible & tested** — every randomness source is seeded; 469 unit tests; pip-installable
...
├── tests/test_bms.py          # 469 unit tests
